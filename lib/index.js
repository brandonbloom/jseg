...
var validate = function validate(schema, val) {
  if (!schema.validate) {
    return val;
  }
  try {
      ...
      for (var field in entity) {
        ...
        if (schema.collection) {
          if (schema.ref) {
            ...
            var _val = validate(schema, entity[field]);
            obj[field] = [].concat(_val);
          }
        } else {
          var _val2 = entity[field];
          if (schema.ref) {
            if (!_val2) {
            ...
            if (!_val2.lid) {
              console.warn('Ref does not have lid: ', _val2);
              continue;
            }
            var _target = Object.assign({}, _val2);
            if (obj[field] !== _val2.lid) {
              obj[field] = _val2.lid;
            ...
            _val2 = validate(schema, _val2);
            if (schema.unique) {
              this._lookup[field][_val2] = lid;
            }
            obj[field] = _val2;
          }
        }
